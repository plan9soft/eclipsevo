...
Private Sub chkBow_Click()
    Dim i As Long
    If chkBow.Value = vbUnchecked Then
        cmbBow.Clear
...
Private Sub Form_Load()
    ...
    Call BitBlt(picSelect.hDC, 0, 0, PIC_X, PIC_Y, picItems.hDC, EditorItemX * PIC_X, EditorItemY * PIC_Y, vbSrcCopy)
