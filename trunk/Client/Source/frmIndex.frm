...
Private Sub cmdOk_Click()
    ...
    If InItemsEditor Then
        Call SendData(POut.EditItem & SEP_CHAR & EditorIndex & END_CHAR)
    End If

    If InNpcEditor Then
        Call SendData(POut.EditNPC & SEP_CHAR & EditorIndex & END_CHAR)
    End If

    If InShopEditor Then
        Call SendData(POut.EditShop & SEP_CHAR & EditorIndex & END_CHAR)
    End If

    If InElementEditor Then
        Call SendData(POut.EditElement & SEP_CHAR & EditorIndex & END_CHAR)
    End If

    If InSpellEditor Then
        Call SendData(POut.EditSpell & SEP_CHAR & EditorIndex & END_CHAR)
    End If

    If InEmoticonEditor Then
        Call SendData(POut.EditEmoticon & SEP_CHAR & EditorIndex & END_CHAR)
    End If

    If InArrowEditor Then
        Call SendData(POut.EditArrow & SEP_CHAR & EditorIndex & END_CHAR)
    End If
