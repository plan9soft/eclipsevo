...
Private Sub BigNpc_Click()
    ...
    If BigNpc.Value = vbChecked Then
        picSprite.Width = 960
...
Private Sub chkDay_Click()
    If chkNight.Value = vbUnchecked Then
        If chkDay.Value = vbUnchecked Then
            chkDay.Value = vbChecked
        End If
    End If
End Sub
...
Private Sub Opt32_Click()
    If Not BigNpc.Value = vbChecked Then
        picSprites.Picture = LoadPicture(App.Path & "\GFX\Sprites.bmp")
