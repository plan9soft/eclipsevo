...
Public Sub AddShopItem(ByVal itemN As Integer, ByVal prc As Integer, ByVal cItem As Integer, Optional ByVal AMT As Integer = 0)
    ...
    If itemN > 0 And itemN <= MAX_ITEMS Then
        ...
        If Item(itemN).Stackable = 1 Or Item(itemN).Type = ITEM_TYPE_CURRENCY Then
...
Private Sub cmdAdd_Click()
    If cmbCurrency.ListIndex > -1 Then
        If lstItems.ListCount = MAX_SHOP_ITEMS Then
            MsgBox "You can't add more than 20 items!", vbExclamation
        Else
            fraAddEditItem.Visible = True
            fraAddEditItem.Caption = "Add Item"
        ...
        End If
    Else
        MsgBox "You must assign a currency before you can add items!", vbExclamation
    End If
End Sub
...
Private Sub cmdEditItem_Click()
    If lstItems.ListIndex > -1 Then
        fraAddEditItem.Visible = True
        fraAddEditItem.Caption = "Edit Item"
        addItem = False
