...
Private Sub picCustom_Click(Index As Integer)
    ...
    packet = POut.CustomMenuClick & SEP_CHAR & MyIndex & SEP_CHAR & Index & SEP_CHAR & CUSTOM_TITLE & SEP_CHAR & Custom_Type & SEP_CHAR & custom_string & END_CHAR
...
Private Sub txtcustomOK_Click(Index As Integer)
    ...
    packet = POut.CustomMenuClick & SEP_CHAR & MyIndex & SEP_CHAR & Index & SEP_CHAR & CUSTOM_TITLE & SEP_CHAR & 2 & SEP_CHAR & custom_string & END_CHAR
    Call SendData(packet)
