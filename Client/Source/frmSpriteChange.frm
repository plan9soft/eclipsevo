...
Private Sub Form_Load()
    ...
    ' Call BitBlt(picSprite.hDC, 0, 0, PIC_X, 64, picSprites.hDC, 3 * PIC_X, scrlSprite.Value * 64, vbSrcCopy)
    Else
        frmSpriteChange.picSprites.Left = (3 * PIC_X) * -1
        frmSpriteChange.picSprites.Top = (scrlSprite.Value * PIC_Y) * -1
    ' Call BitBlt(picSprite.hDC, 0, 0, PIC_X, PIC_Y, picSprites.hDC, 3 * PIC_X, scrlSprite.Value * PIC_Y, vbSrcCopy)
    End If
