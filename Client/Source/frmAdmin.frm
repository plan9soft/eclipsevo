...
Begin VB.Form frmAdmin 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(2).Control(1)=   "btnEditElement"
      Tab(2).Control(1).Enabled=   0   'False
      Tab(2).Control(2)=   "btnEditEmoticon"
      Tab(2).Control(2).Enabled=   0   'False
      Tab(2).Control(3)=   "btnEditArrow"
      Tab(2).Control(3).Enabled=   0   'False
      Tab(2).Control(4)=   "btnEditNPC"
      Tab(2).Control(4).Enabled=   0   'False
      Tab(2).Control(5)=   "btnEditShops"
      Tab(2).Control(5).Enabled=   0   'False
      Tab(2).Control(6)=   "btnEditItem"
      Tab(2).Control(6).Enabled=   0   'False
      Tab(2).Control(7)=   "btnEditSpell"
...
Private Sub PlayerInfo_Click()
    If GetPlayerAccess(MyIndex) >= ADMIN_MAPPER Then
        If LenB(txtPlayerName) <> 0 Then
            Call SendData(POut.GetStats & SEP_CHAR & txtPlayerName.Text & END_CHAR)
        End If
    Else
        Call AddText("You are not authorized to carry out that action.", BRIGHTRED)
    End If
...
Private Sub btnSetNone_Click()
    Call SendData(POut.Weather & SEP_CHAR & 0 & END_CHAR)
End Sub

Private Sub btnSetRain_Click()
    Call SendData(POut.Weather & SEP_CHAR & 1 & END_CHAR)
End Sub

Private Sub btnSetSnow_Click()
    Call SendData(POut.Weather & SEP_CHAR & 2 & END_CHAR)
End Sub

Private Sub btnSetThunder_Click()
    Call SendData(POut.Weather & SEP_CHAR & 3 & END_CHAR)
End Sub
