...
Begin VB.Form frmMapProperties 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(3)=   "cmbNpc(14)"
      Tab(1).Control(3).Enabled=   0   'False
      Tab(1).Control(4)=   "cmbNpc(13)"
      Tab(1).Control(4).Enabled=   0   'False
      Tab(1).Control(5)=   "cmbNpc(12)"
      Tab(1).Control(5).Enabled=   0   'False
      Tab(1).Control(6)=   "cmbNpc(11)"
      Tab(1).Control(6).Enabled=   0   'False
      Tab(1).Control(7)=   "cmbNpc(10)"
      Tab(1).Control(7).Enabled=   0   'False
      Tab(1).Control(8)=   "cmbNpc(9)"
      Tab(1).Control(8).Enabled=   0   'False
      Tab(1).Control(9)=   "cmbNpc(8)"
      Tab(1).Control(9).Enabled=   0   'False
      Tab(1).Control(10)=   "cmbNpc(7)"
      Tab(1).Control(10).Enabled=   0   'False
      Tab(1).Control(11)=   "cmbNpc(6)"
      Tab(1).Control(11).Enabled=   0   'False
      Tab(1).Control(12)=   "cmbNpc(5)"
      Tab(1).Control(12).Enabled=   0   'False
      Tab(1).Control(13)=   "cmbNpc(4)"
      Tab(1).Control(13).Enabled=   0   'False
      Tab(1).Control(14)=   "cmbNpc(3)"
      Tab(1).Control(14).Enabled=   0   'False
      Tab(1).Control(15)=   "cmbNpc(2)"
      Tab(1).Control(15).Enabled=   0   'False
      Tab(1).Control(16)=   "cmbNpc(1)"
      Tab(1).Control(16).Enabled=   0   'False
      Tab(1).Control(17)=   "cmbNpc(0)"
      Tab(1).Control(17).Enabled=   0   'False
      Tab(1).Control(18)=   "cmdClear"
      Tab(1).Control(18).Enabled=   0   'False
      Tab(1).Control(19)=   "cmdCopy(0)"
      Tab(1).Control(19).Enabled=   0   'False
      Tab(1).Control(20)=   "cmdCopy(1)"
      Tab(1).Control(20).Enabled=   0   'False
      Tab(1).Control(21)=   "cmdCopy(2)"
      Tab(1).Control(21).Enabled=   0   'False
      Tab(1).Control(22)=   "cmdCopy(3)"
      Tab(1).Control(22).Enabled=   0   'False
      Tab(1).Control(23)=   "cmdCopy(4)"
      Tab(1).Control(23).Enabled=   0   'False
      Tab(1).Control(24)=   "cmdCopy(5)"
      Tab(1).Control(24).Enabled=   0   'False
      Tab(1).Control(25)=   "cmdCopy(6)"
      Tab(1).Control(25).Enabled=   0   'False
      Tab(1).Control(26)=   "cmdCopy(7)"
      Tab(1).Control(26).Enabled=   0   'False
      Tab(1).Control(27)=   "cmdCopy(8)"
      Tab(1).Control(27).Enabled=   0   'False
      Tab(1).Control(28)=   "cmdCopy(10)"
      Tab(1).Control(28).Enabled=   0   'False
      Tab(1).Control(29)=   "cmdCopy(11)"
      Tab(1).Control(29).Enabled=   0   'False
      Tab(1).Control(30)=   "cmdCopy(12)"
      Tab(1).Control(30).Enabled=   0   'False
      Tab(1).Control(31)=   "cmdCopy(13)"
      Tab(1).Control(31).Enabled=   0   'False
      Tab(1).Control(32)=   "cmdCopy(9)"
      Tab(1).Control(32).Enabled=   0   'False
      Tab(1).Control(33)=   "cmbNpcY(0)"
      Tab(1).Control(33).Enabled=   0   'False
      Tab(1).Control(34)=   "cmbNpcX(1)"
      Tab(1).Control(34).Enabled=   0   'False
      Tab(1).Control(35)=   "cmbNpcY(1)"
      Tab(1).Control(35).Enabled=   0   'False
      Tab(1).Control(36)=   "cmbNpcX(2)"
      Tab(1).Control(36).Enabled=   0   'False
      Tab(1).Control(37)=   "cmbNpcY(2)"
      Tab(1).Control(37).Enabled=   0   'False
      Tab(1).Control(38)=   "cmbNpcX(3)"
      Tab(1).Control(38).Enabled=   0   'False
      Tab(1).Control(39)=   "cmbNpcY(3)"
      Tab(1).Control(39).Enabled=   0   'False
      Tab(1).Control(40)=   "cmbNpcX(4)"
      Tab(1).Control(40).Enabled=   0   'False
      Tab(1).Control(41)=   "cmbNpcY(4)"
      Tab(1).Control(41).Enabled=   0   'False
      Tab(1).Control(42)=   "cmbNpcX(5)"
      Tab(1).Control(42).Enabled=   0   'False
      Tab(1).Control(43)=   "cmbNpcY(5)"
      Tab(1).Control(43).Enabled=   0   'False
      Tab(1).Control(44)=   "cmbNpcX(6)"
      Tab(1).Control(44).Enabled=   0   'False
      Tab(1).Control(45)=   "cmbNpcY(6)"
      Tab(1).Control(45).Enabled=   0   'False
      Tab(1).Control(46)=   "cmbNpcX(7)"
      Tab(1).Control(46).Enabled=   0   'False
      Tab(1).Control(47)=   "cmbNpcY(7)"
      Tab(1).Control(47).Enabled=   0   'False
      Tab(1).Control(48)=   "cmbNpcX(8)"
      Tab(1).Control(48).Enabled=   0   'False
      Tab(1).Control(49)=   "cmbNpcY(8)"
      Tab(1).Control(49).Enabled=   0   'False
      Tab(1).Control(50)=   "cmbNpcX(9)"
      Tab(1).Control(50).Enabled=   0   'False
      Tab(1).Control(51)=   "cmbNpcY(9)"
      Tab(1).Control(51).Enabled=   0   'False
      Tab(1).Control(52)=   "cmbNpcX(10)"
      Tab(1).Control(52).Enabled=   0   'False
      Tab(1).Control(53)=   "cmbNpcY(10)"
      Tab(1).Control(53).Enabled=   0   'False
      Tab(1).Control(54)=   "cmbNpcX(11)"
      Tab(1).Control(54).Enabled=   0   'False
      Tab(1).Control(55)=   "cmbNpcY(11)"
      Tab(1).Control(55).Enabled=   0   'False
      Tab(1).Control(56)=   "cmbNpcX(12)"
      Tab(1).Control(56).Enabled=   0   'False
      Tab(1).Control(57)=   "cmbNpcY(12)"
      Tab(1).Control(57).Enabled=   0   'False
      Tab(1).Control(58)=   "cmbNpcX(13)"
      Tab(1).Control(58).Enabled=   0   'False
      Tab(1).Control(59)=   "cmbNpcY(13)"
      Tab(1).Control(59).Enabled=   0   'False
      Tab(1).Control(60)=   "cmbNpcX(14)"
      Tab(1).Control(60).Enabled=   0   'False
      Tab(1).Control(61)=   "cmbNpcY(14)"
      Tab(1).Control(61).Enabled=   0   'False
      Tab(1).Control(62)=   "cmbNpcX(0)"
      Tab(1).Control(62).Enabled=   0   'False
      Tab(1).Control(63)=   "cmdSetRand"
...
Private Sub cmdPlay_Click()
    If chkURL.Value = 0 Then
        Call MusicPlay(lstMusic.List(lstMusic.ListIndex))
    Else
        ' Currently, we don't support downloadable music.
    End If
End Sub
...
Private Sub Form_Load()
    ...
    ' Clear the list box when loading the form.
    lstMusic.Clear

    ' Set the first option to "None" for no music.
    lstMusic.addItem "None", 0

    ' Populate the list box with the directory files.
    Call ListMusic(lstMusic, App.Path & "\Music\")

    txtMapName.Text = Trim$(Map(GetPlayerMap(MyIndex)).Name)
    txtUp.Text = CStr(Map(GetPlayerMap(MyIndex)).Up)
    txtDown.Text = CStr(Map(GetPlayerMap(MyIndex)).Down)
    txtLeft.Text = CStr(Map(GetPlayerMap(MyIndex)).Left)
    txtRight.Text = CStr(Map(GetPlayerMap(MyIndex)).Right)
    cmbMoral.ListIndex = Map(GetPlayerMap(MyIndex)).Moral
    txtBootMap.Text = CStr(Map(GetPlayerMap(MyIndex)).BootMap)
    txtBootX.Text = CStr(Map(GetPlayerMap(MyIndex)).BootX)
    txtBootY.Text = CStr(Map(GetPlayerMap(MyIndex)).BootY)
    lstMusic.Text = Trim$(Map(GetPlayerMap(MyIndex)).music)
    chkIndoors.Value = CStr(Map(GetPlayerMap(MyIndex)).Indoors)
