...
Private Sub scrlArrow_Change()
    ...
    ' Update the caption.
    lblArrow.Caption = "Arrow: " & CStr(scrlArrow.Value)

    ' Define the source rectangle.
    sRECT.Top = scrlArrow.Value * PIC_Y
    ...
    ' Draw the arrow in the picture.
    Call DD_ArrowAnim.BltToDC(picArrows.hDC, sRECT, dRECT)
...
Private Sub scrlRange_Change()
    lblRange.Caption = "Range: " & CStr(scrlRange.Value)
End Sub
Private Sub scrlAmount_Change()
    lblAmount.Caption = "Amount: " & CStr(scrlAmount.Value)
End Sub
