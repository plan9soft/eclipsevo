...
Public Type ChatBubble
    Text As String
    Created As Long
End Type

Public Type ScriptBubble
    Text As String
    Created As Long
    Map As Long
    X As Long
...
Public Type ElementRec
    Name As String * NAME_LENGTH
    Strong As Long
    Weak As Long
End Type

Public Type SpellAnimRec
    CastedSpell As Byte
...
Public Type ScriptSpellAnimRec
    CastedSpell As Byte
